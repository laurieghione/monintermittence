...
class ModalCloseFolder extends React.Component<modalCloseFolderProps & any> {
    ...
    closeFolder = () =>{
        ...
        closeFolder.name = moment(closeFolder.dateStart!).format('DD-MM-YYYY') + 
    ...
    render() {
        ...
        return (
            <CustomModal title="Clôturer le dossier" open={openModal} 
            handleClose={closeModal} buttonSubmit="Clôturer" 
            body={body} handleSubmit={this.closeFolder}/>)
    }
}
